# UTC+9 ManifestWave Card Prompt
...
Australia (parts); Indonesia (parts); Japan; Korea, Democratic People's Republic of; Korea, Republic of; Palau; Russia (parts); Timor-Leste
...
- [ ] Output filename is `utc-plus-09.png`.
- [ ] Header says `UTC+9 ManifestWave Zone`.
