# UTC+0 ManifestWave Card Prompt
...
Antarctica (parts); Burkina Faso; Cote d'Ivoire; Faroe Islands; Gambia; Ghana; Greenland (parts); Guernsey; Guinea; Guinea-Bissau; Iceland; Ireland; Isle of Man; Jersey; Liberia; Mali; Mauritania; Portugal (parts); Saint Helena, Ascension and Tristan da Cunha; Sao Tome and Principe; Senegal; Sierra Leone; Spain (parts); Togo; United Kingdom
...
- [ ] Output filename is `utc-plus-00.png`.
- [ ] Header says `UTC+0 ManifestWave Zone`.
