...
Country/region count: **3**
Manual-review rows in source chart: **4**
...
Brazil (parts); Greenland (parts); South Georgia and the South Sandwich Islands
...
- [ ] Output filename is `utc-minus-02.png`.
