# UTC+3 ManifestWave Card Prompt
...
Country/region count: **23**
Manual-review rows in source chart: **11**
...
Antarctica (parts); Bahrain; Belarus; Comoros; Djibouti; Eritrea; Ethiopia; Iraq; Jordan; Kenya; Kuwait; Madagascar; Mayotte; Qatar; Russia (parts); Saudi Arabia; Somalia; Syria; Tanzania; Türkiye; Uganda; Ukraine (parts); Yemen
...
- [ ] Output filename is `utc-plus-03.png`.
- [ ] Header says `UTC+3 ManifestWave Zone`.
