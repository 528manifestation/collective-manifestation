# UTC+7 ManifestWave Card Prompt
...
Antarctica (parts); Cambodia; Christmas Island; Cocos (Keeling) Islands; Indonesia (parts); Laos; Mongolia (parts); Myanmar; Russia (parts); Thailand; Vietnam
...
- [ ] Output filename is `utc-plus-07.png`.
- [ ] Header says `UTC+7 ManifestWave Zone`.
