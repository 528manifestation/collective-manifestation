# UTC+12 ManifestWave Card Prompt
...
Country/region count: **9**
Manual-review rows in source chart: **5**
...
Fiji; Kiribati (parts); Marshall Islands; Nauru; Norfolk Island; Russia (parts); Tuvalu; United States Minor Outlying Islands (parts); Wallis and Futuna
...
- [ ] Output filename is `utc-plus-12.png`.
- [ ] Header says `UTC+12 ManifestWave Zone`.
