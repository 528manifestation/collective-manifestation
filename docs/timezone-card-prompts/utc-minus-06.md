# UTC-6 ManifestWave Card Prompt
...
Manual-review rows in source chart: **21**
...
Belize; Canada (parts); Costa Rica; Ecuador (parts); El Salvador; Guatemala; Honduras; Mexico (parts); Nicaragua; United States (parts)
...
- [ ] Output filename is `utc-minus-06.png`.
- [ ] Header says `UTC-6 ManifestWave Zone`.
