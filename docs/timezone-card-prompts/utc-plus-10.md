# UTC+10 ManifestWave Card Prompt
...
Antarctica (parts); Australia (parts); Guam; Micronesia, Federated States of (parts); Northern Mariana Islands; Papua New Guinea (parts); Russia (parts)
...
- [ ] Output filename is `utc-plus-10.png`.
- [ ] Header says `UTC+10 ManifestWave Zone`.
