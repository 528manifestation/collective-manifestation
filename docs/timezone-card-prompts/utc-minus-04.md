# UTC-4 ManifestWave Card Prompt
...
Country/region count: **29**
Manual-review rows in source chart: **25**
...
Anguilla; Antigua and Barbuda; Aruba; Barbados; Bermuda; Bolivia, Plurinational State of; Bonaire, Sint Eustatius and Saba; Brazil (parts); British Virgin Islands; Canada (parts); Curacao; Dominica; Dominican Republic; Greenland (parts); Grenada; Guadeloupe; Guyana; Martinique; Montserrat; Puerto Rico; Saint Barthelemy; Saint Kitts and Nevis; Saint Lucia; Saint Martin; Saint Vincent and the Grenadines; Sint Maarten (Dutch part); Trinidad and Tobago; U.S. Virgin Islands; Venezuela, Bolivarian Republic of
...
- [ ] Output filename is `utc-minus-04.png`.
- [ ] Header says `UTC-4 ManifestWave Zone`.
