...
Country/region count: **5**
Manual-review rows in source chart: **6**
...
Cook Islands; French Polynesia (parts); Kiribati (parts); New Zealand (parts); United States (parts)
...
- [ ] Output filename is `utc-minus-10.png`.
