# UTC+2 ManifestWave Card Prompt
...
Country/region count: **31**
Manual-review rows in source chart: **12**
...
Botswana; Bulgaria; Burundi; Congo, Democratic Republic of the (parts); Cyprus; Egypt; Estonia; Eswatini; Finland; Greece; Israel; Latvia; Lebanon; Lesotho; Libya; Lithuania; Malawi; Moldova, Republic of; Mozambique; Namibia; Palestine, State of; Romania; Russia (parts); Rwanda; South Africa; South Sudan; Sudan; Ukraine (parts); Zambia; Zimbabwe; Åland Islands
...
- [ ] Output filename is `utc-plus-02.png`.
- [ ] Header says `UTC+2 ManifestWave Zone`.
