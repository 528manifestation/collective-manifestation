# UTC-11 ManifestWave Card Prompt
...
Manual-review rows in source chart: **8**
...
American Samoa; Antarctica (parts); Kiribati (parts); New Zealand (parts); Niue; Samoa; Tokelau; Tonga; United States Minor Outlying Islands (parts)
...
- [ ] Output filename is `utc-minus-11.png`.
- [ ] Header says `UTC-11 ManifestWave Zone`.
