...
Manual-review rows in source chart: **7**
...
Bangladesh; Bhutan; British Indian Ocean Territory; China (parts); India; Kyrgyzstan; Nepal; Russia (parts); Sri Lanka
...
- [ ] Output filename is `utc-plus-06.png`.
