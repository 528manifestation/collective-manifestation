...
Country/region count: **10**
Manual-review rows in source chart: **15**
...
Antarctica (parts); Argentina; Brazil (parts); Chile (parts); Falkland Islands (Malvinas); French Guiana; Paraguay; Saint Pierre and Miquelon; Suriname; Uruguay
...
- [ ] Output filename is `utc-minus-03.png`.
