...
Country/region count: **7**
Manual-review rows in source chart: **14**
...
Australia (parts); Micronesia, Federated States of (parts); New Caledonia; Papua New Guinea (parts); Russia (parts); Solomon Islands; Vanuatu
...
- [ ] Output filename is `utc-plus-11.png`.
