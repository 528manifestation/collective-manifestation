# UTC+5 ManifestWave Card Prompt
...
Afghanistan; Antarctica (parts); French Southern Territories (parts); Kazakhstan; Maldives; Pakistan; Russia (parts); Tajikistan; Turkmenistan; Uzbekistan
...
- [ ] Output filename is `utc-plus-05.png`.
- [ ] Header says `UTC+5 ManifestWave Zone`.
